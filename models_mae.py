...
class MaskedAutoencoderViT(nn.Layer):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3,
                 ...
                 mlp_ratio=4., norm_layer=partial(nn.LayerNorm, epsilon=1e-6), norm_pix_loss=False):
        super().__init__()
    ...
    def initialize_weights(self):
        ...
        self.decoder_pos_embed.copy_(paddle.to_tensor(decoder_pos_embed).astype(paddle.float32).unsqueeze(0), False)
