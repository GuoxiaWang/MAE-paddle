...
def main(args):
    ...
    if True:  # args.distributed:
        ...
        sampler_train = paddle.io.DistributedBatchSampler(
            dataset_train, num_replicas=num_tasks, rank=global_rank, shuffle=True, batch_size=args.batch_size, drop_last=True
        )
    ...
    optimizer = plsc.optimizer.AdamW(param_groups, lr=args.lr, betas=(0.9, 0.95))
    print(optimizer)
